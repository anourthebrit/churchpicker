...
$query="select opt, count(ans_id) as no, opt1,opt2,opt3,qst  from poll_answer left join poll_qst on poll_qst.qst_id=poll_answer.qst_id where poll_answer.qst_id=$i group by opt";
